...
export default function Home() {
  ...
  const handleSearch = async () => {
    console.log('handleSearch called'); // Log that the function is entered
    console.log('Refs available:', { geocoder: !!geocoderRef.current, map: !!mapInstanceRef.current }); // Log refs status
    if (!address.trim() || !geocoderRef.current || !mapInstanceRef.current) {
        console.log('handleSearch: Returning early due to missing address or refs.');
        return;
    }
    setSearching(true);
    setError('');
